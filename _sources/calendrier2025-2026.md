...
```{note}
Par exemple, le choix du mode de documentation 
doit être envoyé au plus tard le dimanche 27 septembre à 23h59.
```
...
|:-----------:|:------:|:-----------:|
| 21/9 |Prise de contact des équipes <br> Rendu du choix du sujet | Modalités de travail en groupe (création d'un espace de travail collaboratif en ligne, créneaux hebdomadaires de travail en commun)|
| 12/10 | Rendu des fiches de lecture des trois modes de documentation | Classement par sources des informations recueillies |
| 26/10 | Rendu de la synthèse de cours |  |
